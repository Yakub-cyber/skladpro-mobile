...
// Типы складских документов (реестр)
...
export const DOC_STATUS = {
  draft: { label: 'Черновик', color: 'warn' },
  posted: { label: 'Проведён', color: 'ok' },
  cancelled: { label: 'Отменён', color: 'bad' },
}
...
// Рабочие зоны склада — сервисные точки на карте. Значения по умолчанию
// используются, если у склада нет своего массива `workZones`. Экшн
// setWorkZone в сторе позволяет менять координаты (редактор карты
// на мобилке — отдельная задача).
